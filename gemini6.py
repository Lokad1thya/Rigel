...
#the online service that is working as a life saver for now ha ha streamlink!!
import streamlit as st
import os
# to observe network delay and timeline.
import time
#upload pdfs thing.
import PyPDF2
...
# Configure the generative AI its in the .env file just incase you need to change it!
...
# Streamlit app setup
st.set_page_config(page_title="A studdy buddy.")
